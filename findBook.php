<?php
    ...
    $sql1 = "select * from Books_YB19937 where bookName like '%$search%' or bookDescription like '%$search%'";
    ...
    <main>
        ...
        <section class="news-nav">
				...
				?>
					<section>
					<article>
					<img src=images/<?=$row['image']?> width=40%> <br><br> <?=$row['bookName']?> <br> <br> <?=$row['bookDescription']?> 
						<br><br> <a href=details.php?bookID=<?=$row['bookID']?>>Details</a>
					</article>
					</section>
				<?php
				}
