...
$sql1 = "Select * from Books_YB19937";
        ...
        <div class="container">
            <center>
				  <form method =post action="sendContact.php">
					...
					<textarea id="message" name="message" placeholder="Write you message.." style="height:200px"></textarea><br><br><br>

					<input type="submit" value="Submit" style="margin-left:50px"><br><br>
				  </form>
            </center>
            <br><br>
        </div>
